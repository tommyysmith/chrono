  ...
  return (
    (<DayPicker
      ...
      classNames={{
        ...
        caption: "flex justify-between relative items-center px-4",
        ...
        day: cn(
          ...
          "h-7 w-7 p-0 font-normal text-light-text dark:text-dark-text hover:bg-black/5 dark:hover:bg-white/5 rounded-[5px]"
        ),
        day_range_end: "day-range-end",
        day_selected: "bg-light-bg-lighter dark:bg-dark-bg border border-light-border dark:border-dark-border text-light-text dark:text-dark-text hover:bg-primary  focus:bg-primary focus:text-primary-foreground rounded-[5px]",
        day_today: "bg-primary text-dark-text dark:text-dark-text rounded-[5px]",
